...
class UserResourceTest {
        ...
        public static final JsonObjectBuilder createDefaultUserJson() {
                return jakarta.json.Json.createObjectBuilder()
                                .add("name", "test")
                                .add("password", "test")
                                .add("roles", jakarta.json.Json.createArrayBuilder()
                                                .add("user"));
        }
        ...
        void create() {
                given()
                                .body(createDefaultUserJson().build().toString())
        ...
        void update() {
                var user = given()
                                ...
                                .as(User.class);
                given()
                                .body("{\"name\":\"updated\",\"password\":\"test\",\"roles\":[\"user\"]}")
                                .contentType(ContentType.JSON)
                                .when().put("/api/v1/users/{id}", user.id)
                                .then()
                                .statusCode(200)
                                .body(
                                                "name", is("updated"),
        ...
        void delete() {
                ...
                given()
                                ...
                                .statusCode(204);
                given()
                                .when().get("/api/v1/users/" + toDelete.id)
                                .then()
                                .statusCode(404);
        }
